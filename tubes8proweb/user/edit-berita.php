...
if (isset($_POST['btn_edit'])) {
    ...
    if($judul !== '' && $isi_berita != ''){
        ...
        echo "<script>alert('Data gagal diperbaharui!'); window.location = 'edit-berita.php'</script>";
    }
          ...
          <form action="" method="POST"   enctype="multipart/form-data">
              <div class="row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        <textarea class="form-control input-sm" name="isi_berita" id="isitext" rows="20"><?php echo $var_isiberita; ?></textarea>
                      </div>
                     </div>
                    <div class="col-sm-4">
                      <div class="form-group">
